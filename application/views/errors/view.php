...
<body class="hold-transition skin-green sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <button class="btn btn-default" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> Refresh Tabel</button>
        <br />
        <br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="add_person()" data-dismiss="modal">Add Detail</button>
